...
class Board() : JPanel(), ActionListener
{
    ...
    public var showBest = true
    private var ai: Individual
    private var currentGeneration: MutableList<Individual> = mutableListOf<Individual>()
    private val population: Population
    private var currentAiNumber = 0
    private var generationNumber = 0
    public var numberOfSnakes = 500
    ...
    init {
        ...
        this.population = Population(numberOfSnakes)
        currentGeneration = this.population.population
    ...
    private fun doDrawing(g: Graphics) {
        ...
        if (inGame)
        {
            ...
            g.color = Color.WHITE
            g.font = g.font.deriveFont(24f)
            g.drawString("Generation: $generationNumber Current snake: $currentAiNumber", 0, g.font.size)
    ...
    private fun gameOver(g: Graphics) {
        ...
        var lock = true
        if (currentAiNumber < numberOfSnakes - 1)
        {
            currentAiNumber += 1
        }
        else {
